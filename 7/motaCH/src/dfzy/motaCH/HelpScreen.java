...
public class HelpScreen extends ViewCH
{
	...
	public HelpScreen(Context context, MainCH mainGame)
	{
		super(context);
		mMainGame = mainGame;
		paint = new Paint();
		...
		tu.InitText(((String) r.getString(R.string.help)), 0, 0, yaCH.SCREENW, yaCH.SCREENH, 0x0, 0xff0000, 255, yaCH.TextSize);
	}
