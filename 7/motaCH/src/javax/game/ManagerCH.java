...
public class ManagerCH {
	 ...
	 */
	public void insert(LayerCH l, int index) {
	 ...
	 **/
	public LayerCH getLayerAt(int index) {
		if ((index < 0) || (index >= nlayers)) {
			throw new IndexOutOfBoundsException();
		}
	 ...
	 */
	private void addImpl(LayerCH layer, int index) {
		// Add component to list;
		// allocate new array if necessary.

		if (nlayers == component.length) {
			LayerCH newcomponents[] = new LayerCH[nlayers + 4];
	 ...
	 **/
	private void removeImpl(LayerCH l) {
		if (l == null) {
	 ...
	 * @see #append(LayerCH)
	 */
	private LayerCH component[] = new LayerCH[4];
